...
// 2
// Plugins const val const val const val const val const val const val
...
// This defines version numbers for some of the libraries you’ll use.
...
object Compose {
    ...
    const val runtime_livedata = "androidx.runtime:runtime_livedata:${Versions.compose_version}"
...
object JetBrains {
    ...
    const val uiUtil = "org.jetbrains.compose.ui:ui_util:${Versions.desktop_compose_plugin}"
}
**/